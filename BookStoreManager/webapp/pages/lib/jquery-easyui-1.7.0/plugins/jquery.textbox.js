...
(function ($) {
    ...
    function _6(_7) {
        ...
        if (_9.buttonText || _9.buttonIcon) {
            var _b = $("<a href=\"javascript:;\" class=\"textbox-button\"></a>")
                .prependTo(tb);
    ...
    function _12(_13, _14) {
        ...
        if (_16.label && _16.labelPosition) {
            if (_16.labelPosition == "top") {
                _15.label._size({
                    width: _16.labelWidth == "auto"
                        ? tb.outerWidth()
                        : _16.labelWidth
                }, tb);
                if (_16.height != "auto") {
                    tb._size("height", tb.outerHeight()
                        - _15.label.outerHeight());
                }
            } else {
                _15.label._size({
        ...
        var _1c = tb.width() - _1b.length * _16.iconWidth - _1d("left")
            - _1d("right");
        var _1e = _16.height == "auto" ? _19.outerHeight() : (tb.height()
            - _1d("top") - _1d("bottom"));
    ...
    function _28(_29) {
        ...
        if (!_2b.disabled && !_2b.readonly) {
            ...
            _2c.bind("blur.textbox", function (e) {
                ...
                tb.closest(".form-field")
                    .removeClass("form-field-focused");
    ...
    function _e(_3b, _3c) {
        ...
        tb.removeClass("textbox-readonly").addClass(_3e.readonly
            ? "textbox-readonly"
            : "");
    };
    ...
    $.fn.textbox.parseOptions = function (_69) {
        var t = $(_69);
        return $.extend({}, $.fn.validatebox.parseOptions(_69), $.parser
            .parseOptions(_69, ["prompt", "iconCls", "iconAlign",
