...
(function ($) {
    ...
    function _d(_e, c) {
        ...
        if (_11 != -1) {
            ...
            if (r.test(c)) {
                ...
                _11 = _12(_e, ++_11);
                $(_e).maskedbox("setSelectionRange", {
                    start: _11,
                    end: _11
                });
            }
    ...
    function _16(_17, _18) {
        ...
        $(_17).maskedbox("setSelectionRange", {
            start: _1b,
            end: _1b
        });
    };
    ...
    $.extend($.fn.textbox.methods, {
        inputMask: function (jq, _2a) {
            return jq.each(function () {
                var _2b = this;
                var _2c = $.extend({}, $.fn.maskedbox.defaults,
                    _2a);
                $.data(_2b, "maskedbox", {
                    options: _2c
                });
    ...
    $.fn.maskedbox.parseOptions = function (_36) {
        var t = $(_36);
        return $.extend({}, $.fn.textbox.parseOptions(_36), $.parser
            .parseOptions(_36, ["mask", "promptChar"]), {});
    };
