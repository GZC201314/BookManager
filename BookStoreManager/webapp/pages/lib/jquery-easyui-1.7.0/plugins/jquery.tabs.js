...
(function ($) {
    ...
    function _2(_3) {
        ...
        if (_4.tabPosition == "left" || _4.tabPosition == "right") {
            ...
            var _b = {
                marginTop: _4.toolPosition == "top" ? _6.outerHeight() : 0
            };
            _6.css(_a);
            _9.css(_b);
            return;
    ...
    function _f(_10) {
        ...
        if (_11.tools) {
            if (typeof _11.tools == "string") {
                ...
                var _13 = $("<div class=\"tabs-tool\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"height:100%\"><tr></tr></table></div>")
                    .appendTo(_12);
                var tr = _13.find("tr");
                for (var i = 0; i < _11.tools.length; i++) {
                    ...
                    _14.linkbutton($.extend({}, _11.tools[i], {
                        plain: true
                    }));
                }
            }
    ...
    function _15(_16, _17) {
        ...
        if (_19.tabPosition == "left" || _19.tabPosition == "right") {
            ...
            _1a.add(_1b)._size("height",
                isNaN(parseInt(_19.height)) ? "" : cc.height());
            ...
            _1a
                ...
                .css("display", _19.showHeader ? "block" : "none");
            ...
            ul._outerHeight(ul.outerHeight() - ul.height() - 1 + _19.tabHeight)
                .css("width", "");
            _1b._size("height", isNaN(parseInt(_19.height))
                ? ""
                : (cc.height() - _1a.outerHeight()));
        ...
        if (_18.tabs.length) {
            ...
            var _1d = _1a.width()
                - _1a.children(".tabs-tool:not(.tabs-tool-hidden)")
                    ._outerWidth();
            var _1e = Math.floor((_1d - d1 - d2 * _18.tabs.length)
                / _18.tabs.length);
            $.map(_18.tabs, function (p) {
                _1f(p, (_19.justified && $.inArray(_19.tabPosition, [
                    "top", "bottom"]) >= 0)
                    ? _1e
                    : undefined);
            });
            if (_19.justified
                && $.inArray(_19.tabPosition, ["top", "bottom"]) >= 0) {
        ...
        function _1f(p, _21) {
            ...
            var _21 = _21 ? _21 : (parseInt(_22.tabWidth || _19.tabWidth
                || undefined));
            if (_21) {
                p_t._outerWidth(_21);
            } else {
    ...
    function _30(_31) {
        ...
        $(_31).children("div.tabs-header").unbind().bind("click", function (e) {
                ...
                if ($(e.target).hasClass("tabs-scroller-right")) {
                    ...
                    if (a.length) {
                        ...
                        if (li.length) {
                            ...
                            if (_36.collapsible) {
                                _36.closed ? _53(_31, _35) : _7b(_31,
                                    _35);
                            } else {
                                _53(_31, _35);
                            }
            ...
            if (li.length) {
                _33.onContextMenu.call(_31, e, li.find("span.tabs-title")
                    .html(), _34(li));
            }
        });
    ...
    function _38(_39) {
        ...
        _3b.removeClass("tabs-header-narrow").addClass(_3a.narrow
            ? "tabs-header-narrow"
            : "");
        var _3d = _3b.find(".tabs");
        _3d.removeClass("tabs-pill").addClass(_3a.pill ? "tabs-pill" : "");
        _3d.removeClass("tabs-narrow")
            .addClass(_3a.narrow ? "tabs-narrow" : "");
        _3d.removeClass("tabs-justified").addClass(_3a.justified
            ? "tabs-justified"
            : "");
        if (_3a.border == true) {
    ...
    function _3e(_3f, _40, pp) {
        ...
        pp.panel($.extend({}, _40, {
            ...
            onClose: function () {
                ...
                _41.options.onUnselect.call(_3f, _4c.title, _4d(_3f,
                    this));
            }
        }));
        $(_3f).tabs("update", {
    ...
    function _54(_55, _56) {
        ...
        var _59 = _58.title;
        $.extend(_58, _56.options, {
            iconCls: (_56.options.icon ? _56.options.icon : undefined)
        });
        ...
        if (_56.type == "all" || _56.type == "header") {
            ...
            if (_58.header) {
                ...
                if (_58.tools) {
                    ...
                    if (!_5c.length) {
                        var _5c = $("<span class=\"tabs-p-tool\"></span>")
    ...
    $.fn.tabs.parseOptions = function (_9d) {
        return $.extend({}, $.parser.parseOptions(_9d, ["tools",
