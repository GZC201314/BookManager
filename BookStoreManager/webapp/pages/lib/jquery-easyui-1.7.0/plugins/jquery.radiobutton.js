...
(function ($) {
    ...
    function _2(_3) {
        var _4 = $("<span class=\"radiobutton inputbox\">"
    ...
    function _c(_18, _19) {
        if (_19) {
            ...
            f.find(".radiobutton-f[radiobuttonName=\"" + _1a + "\"]").each(
                function () {
                    if (this != _18) {
                        _1b(this, false);
                    }
    ...
    $.fn.radiobutton.methods = {
        options: function (jq) {
            ...
            return $.extend(_26.options, {
                value: _26.radiobutton.find(".radiobutton-value")
                    .val()
            });
        },
        setValue: function (jq, _27) {
            return jq.each(function () {
                $(this).val(_27);
                $.data(this, "radiobutton").radiobutton
                    .find(".radiobutton-value").val(_27);
            });
        },
        enable: function (jq) {
            return jq.each(function () {
    ...
    $.fn.radiobutton.parseOptions = function (_29) {
        var t = $(_29);
        return $.extend({}, $.parser.parseOptions(_29, ["label",
