...
(function($) {
	...
	function _22(_23) {
		...
		if (_28.closed) {
			...
			_26.panel("resize", {
						width : (_27.panelWidth ? _27.panelWidth : _25
								._outerWidth()),
		...
		function _29() {
			...
			if (_2b + _26._outerWidth() > $(window)._outerWidth()
					+ $(document).scrollLeft()) {
		...
		function _2a() {
			if (_27.panelValign == "top") {
				...
				if (_27.panelValign == "bottom") {
					...
					var top = _25.offset().top + _25._outerHeight();
					if (top + _26._outerHeight() > $(window)._outerHeight()
							+ $(document).scrollTop()) {
	...
	function _39(_3a, _3b) {
		...
		function _40(_41) {
			...
			var _43 = $("<input type=\"hidden\" class=\"textbox-value\">")
					.appendTo(_3d);
			_43.attr("name", _42);
			if (_3e.disabled) {
					...
					if (_52) {
						...
						_52 = $.data(this, "combo", {
									options : $.extend({}, $.fn.combo.defaults,
											$.fn.combo.parseOptions(this), _4f),
									previousText : ""
								});
	...
	$.fn.combo.parseOptions = function(_5a) {
		var t = $(_5a);
		return $.extend({}, $.fn.textbox.parseOptions(_5a), $.parser
						.parseOptions(_5a, ["separator", "panelAlign", {
											panelWidth : "number",
