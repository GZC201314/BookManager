    ...
    function _19(_1a, _1b, el) {
        ...
        _22.resizable($.extend({}, {
            ...
            onResize: function (e) {
                if (dir == "north" || dir == "south") {
                    ...
                    var top = dir == "north"
                        ? e.data.height - _29.height()
                        : $(_1a).height() - e.data.height;
                    _29.css("top", top);
                } else {
                    var _2a = _28(this);
                    ...
                    var _2b = dir == "west"
                        ? e.data.width - _29.width()
                        : $(_1a).width() - e.data.width;
                    _29.css("left", _2b);
                }
                return false;
            },
        ...
        function _28(p) {
            var _2c = "expand" + dir.substring(0, 1).toUpperCase()
                + dir.substring(1);
            var _2d = _1c["center"];
            var _2e = (dir == "north" || dir == "south")
                ? "minHeight"
                : "minWidth";
            var _2f = (dir == "north" || dir == "south")
                ? "maxHeight"
                : "maxWidth";
            var _30 = (dir == "north" || dir == "south")
                ? "_outerHeight"
                : "_outerWidth";
    ...
    function _39(_3a, _3b, _3c) {
            ...
            if (!_3e.expandMode) {
                ...
                ep.bind("click", function () {
                    if (_3e.expandMode == "dock") {
                        ...
                        p.panel("panel").unbind(".layout").bind(
                            "mouseleave.layout", {
                                region: _3b
                            }, function (e) {
                                $(this).stop(true, true);
                        ...
                        p.panel("panel").animate(_41.expand, function () {
                            $(_3a).layout("options").onExpand.call(_3a,
                                _3b);
                        });
                    }
                    return false;
        ...
        function _40(dir) {
            ...
            p.panel($.extend({}, $.fn.layout.paneldefaults, {
                ...
                iconCls: (_3e.hideCollapsedContent
                    ? null
                    : _3e.iconCls),
                closed: true,
                minWidth: 0,
                ...
                onResize: function () {
                    ...
                    if (_47.length) {
                        ...
                        var _48 = ($(this).width() - Math.min(_47
                                ._outerWidth(), _47
                                ._outerHeight()))
                            / 2;
            ...
            if (!_3e.hideCollapsedContent) {
                var _49 = typeof _3e.collapsedContent == "function"
                    ? _3e.collapsedContent.call(p[0], _3e.title)
            ...
            if (_3b == "east") {
                ...
                if (_3b == "west") {
                    ...
                    if (_3b == "north") {
                        ...
                        _3d.east.add(_3d.west).add(_3d.expandEast)
                            .add(_3d.expandWest).panel("resize", {
                            top: _4b - 1,
                            height: hh
                        });
                        return {
    ...
    $.fn.layout = function (_65, _66) {
        ...
        return this.each(function () {
            ...
            if (_67) {
                ...
                var _68 = $.extend({}, $.fn.layout.defaults,
                    $.fn.layout.parseOptions(this), _65);
                $.data(this, "layout", {
                    options: _68,
                    panels: {
                        center: $(),
