...
(function($) {
	...
	function _28(_29, pp, _2a) {
		...
		pp.panel($.extend({}, {
					...
					onExpand : function() {
						$(_29).find(">.panel-last>.accordion-header")
								.removeClass("accordion-header-border");
						if (_2a.onExpand) {
							_2a.onExpand.call(this);
						}
						_2b.onSelect.call(_29, $(this).panel("options").title,
								_19(_29, this));
					},
					...
					onCollapse : function() {
						...
						_2b.onUnselect.call(_29,
								$(this).panel("options").title, _19(_29, this));
					}
				}));
		...
		var t = $("<a href=\"javascript:;\"></a>")
				.addClass("accordion-collapse accordion-expand").appendTo(_2f);
	...
	function _3c(_3d) {
		...
		$(_3d).find(">.panel-last>.accordion-header")
				.addClass("accordion-header-border");
	...
	$.fn.accordion.parseOptions = function(_5d) {
		var t = $(_5d);
		return $.extend({}, $.parser.parseOptions(_5d, ["width", "height",
								"halign", {
									fit : "boolean",
									border : "boolean",
									animate : "boolean",
