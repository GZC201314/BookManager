...
(function($) {
	function _1(_2) {
		...
		function _7() {
			...
			$.map($(_2).tagbox("getValues"), function(_e, _f) {
						...
						var _11 = $("<span class=\"tagbox-label\"></span>")
								.insertBefore(_d).html(_10);
	...
	function _1c(_1d) {
		...
		_1e.unbind(".tagbox").bind("click.tagbox", function(e) {
					...
					if ($(e.target).hasClass("tagbox-remove")) {
						var _20 = parseInt($(e.target).parent()
								.attr("tagbox-index"));
			...
			if ($(e.target)
					.closest(".textbox-button,.textbox-addon,.tagbox-label").length) {
	...
	function _2c(_2d) {
		...
		if (_2e.limitToList) {
			...
			if (_30.length) {
				...
				$(_2d).tagbox(
						_30.hasClass("combobox-item-selected")
								? "unselect"
								: "select", _31);
			}
	...
	$.fn.tagbox.parseOptions = function(_3c) {
		return $.extend({}, $.fn.combobox.parseOptions(_3c), $.parser
						.parseOptions(_3c, []));
	};
	$.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
				...
				keyHandler : $.extend({}, $.fn.combobox.defaults.keyHandler, {
							...
							query : function(q, e) {
								...
								if (_40.limitToList) {
									$.fn.combobox.defaults.keyHandler.query
											.call(this, q, e);
								} else {
									$(this).combobox("hidePanel");
								}
