...
(function ($) {
    ...
    function _1f(_20) {
        ...
        _23.removeClass("panel-hleft panel-hright").addClass("panel-h"
            + _22.halign);
        _24();
        _25();
            ...
            if (_22.noheader || (!_22.title && !_22.header)) {
                ...
                if (_22.header) {
                    ...
                    if (!$.isArray(_22.tools)) {
                        _29.find("div.panel-tool .panel-tool-a")
                            .appendTo(_22.tools);
                    }
                    _29.empty();
                    var _2a = $("<div class=\"panel-title\"></div>")
                        .html(_22.title).appendTo(_29);
                    if (_22.iconCls) {
                        _2a.addClass("panel-with-icon");
                        $("<div class=\"panel-icon\"></div>")
                            .addClass(_22.iconCls).appendTo(_29);
                    }
                    if (_22.halign == "left" || _22.halign == "right") {
                        _2a.addClass("panel-title-" + _22.titleDirection);
                    }
                    var _2b = $("<div class=\"panel-tool\"></div>")
                        .appendTo(_29);
                        ...
                        if ($.isArray(_22.tools)) {
                            ...
                            $(_22.tools).children().each(function () {
                                $(this).addClass($(this).attr("iconCls"))
                                    .addClass("panel-tool-a").appendTo(_2b);
                            });
                        }
                    }
                    if (_22.collapsible) {
    ...
    function _2f(_30, _31) {
        ...
        if (!_32.isLoaded || !_33.cache) {
            ...
            if (_33.loadingMessage) {
                $(_30).panel("clear");
                $(_30).html($("<div class=\"panel-loading\"></div>")
                    .html(_33.loadingMessage));
            }
            ...
            return jq.each(function () {
                ...
                function _7c(_7d, _7e) {
                    ...
                    var s = $(_7d)
                        ...
                        .filter(function (_80, el) {
                            var p = $(el).parents(".panel-" + _7e
                                + ":first");
