...
(function($) {
	...
	function _17(_18) {
		...
		_1c.html("<a href=\"javascript:;\" class=\"slider-handle\"></a>"
				+ "<span class=\"slider-tip\"></span>");
		if (_1a.range) {
			_1c.append("<a href=\"javascript:;\" class=\"slider-handle\"></a>"
					+ "<span class=\"slider-tip\"></span>");
		}
	...
	function _27(_28, _29) {
		...
		for (var i = 0; i < _29.length; i++) {
			...
			var _31 = $("<input type=\"hidden\" class=\"slider-value\">")
					.appendTo(_2c);
			_31.attr("name", _2f);
			_31.val(_30);
			_2e.push(_30);
			...
			if (_2b.mode == "h") {
				var _34 = "left:" + pos + "px;";
				_32.attr("style", _34);
				tip.attr("style", _34 + "margin-left:"
	...
	function _25(_3d, pos) {
		...
		var pos = _3f.mode == "h"
				? (_3f.reversed ? (_41 - pos) : pos)
				: (_3f.reversed ? pos : (_41 - pos));
		...
		return this.each(function() {
					...
					if (_46.range) {
						if (!$.isArray(_46.value)) {
							_46.value = $.map(String(_46.value)
											.split(_46.separator), function(v) {
										return parseFloat(v);
									});
						}
	...
	$.fn.slider.methods = {
		...
		reset : function(jq) {
			return jq.each(function() {
						...
						$(this).slider(_4b.range ? "setValues" : "setValue",
								_4b.originalValue);
					});
		},
		enable : function(jq) {
	...
	$.fn.slider.parseOptions = function(_4c) {
		var t = $(_4c);
		return $.extend({}, $.parser.parseOptions(_4c, ["width", "height",
								"mode", {
									reversed : "boolean",
									showTip : "boolean",
									range : "boolean",
