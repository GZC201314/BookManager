	...
	var _18 = $.extend({}, $.fn.datagrid.defaults.view, {
		...
		renderGroup : function(_1e, _1f, _20, _21) {
			...
			for (var j = 0; j < _20.rows.length; j++) {
				var css = _23.rowStyler ? _23.rowStyler.call(_1e, _28,
						_20.rows[j]) : "";
				var _29 = "";
				var _2a = "";
				...
				var cls = "class=\"datagrid-row "
						+ (_28 % 2 && _23.striped ? "datagrid-row-alt " : " ")
						+ _29 + "\"";
				var _2b = _2a ? "style=\"" + _2a + "\"" : "";
				var _2c = _22.rowIdPrefix + "-" + (_21 ? 1 : 2) + "-" + _28;
				_26.push("<tr id=\"" + _2c + "\" datagrid-row-index=\"" + _28
						+ "\" " + cls + " " + _2b + ">");
				_26.push(this.renderRow.call(this, _1e, _24, _21, _28,
						_20.rows[j]));
				_26.push("</tr>");
				_28++;
			}
		...
		bindEvents : function(_2f) {
			...
			_31.unbind("click").bind("click", function(e) {
				...
				if (_33.length) {
					var _34 = _33.closest("div.datagrid-group")
							.attr("group-index");
				...
				if (!$("#datagrid-group-style").length) {
					$("head")
							.append("<style id=\"datagrid-group-style\">"
									...
									+ Math.floor((_38.groupHeight - 16) / 2)
	...
	$.extend($.fn.datagrid.methods, {
				...
				expandGroup : function(jq, _4a) {
					return jq.each(function() {
								...
								var _4d = _4c.find(_4a != undefined
								...
								if (_4e.hasClass("datagrid-row-expand")) {
									_4e.removeClass("datagrid-row-expand")
				...
				collapseGroup : function(jq, _4f) {
					return jq.each(function() {
								...
								var _52 = _51.find(_4f != undefined
										? "div.datagrid-group[group-index=\""
												+ _4f + "\"]"
										: "div.datagrid-group");
								var _53 = _52
								...
								if (_53.hasClass("datagrid-row-collapse")) {
									_53.removeClass("datagrid-row-collapse")
					...
					return jq.each(function() {
								...
								if (_56.length) {
									...
									var _58 = dc.view2
											...
											._outerHeight();
									var _59 = dc.body2.outerHeight(true)
	...
	$.extend(_18, {
		refreshGroupTitle : function(_5a, _5b) {
			...
			var _5f = dc.body1.add(dc.body2)
					.children("div.datagrid-group[group-index=" + _5b + "]")
		...
		resizeGroup : function(_60, _61) {
			...
			if (_61 == undefined) {
				...
				var _63 = dc.body2.children("div.datagrid-group[group-index="
						+ _61 + "]");
			}
			_63._outerWidth(ww);
			var _64 = _62.options;
			if (_64.frozenColumns && _64.frozenColumns.length) {
				...
				_63.find(".datagrid-group-title").css(_66 ? "right" : "left",
						-_65 + "px");
			}
			if (fr.length) {
		...
		insertRow : function(_67, _68, row) {
			...
			if (_6b) {
				...
				dc.body1.append(this.renderGroup
						.call(this, _67, _6c, _6b, true));
				dc.body2.append(this.renderGroup.call(this, _67, _6c, _6b,
						false));
		...
		updateRow : function(_72, _73, row) {
			...
			var tb = _74.finder.getTr(_72, _73, "body", 2)
		...
		deleteRow : function(_76, _77) {
			...
			var tb = _79.finder.getTr(_76, _77, "body", 2)
					.closest("table.datagrid-btable");
			...
			if (_7c.rows.length > 1) {
				...
				_7a.children("div.datagrid-group[group-index=" + _7b + "]")
						.remove();
				for (var i = _7b + 1; i < this.groups.length; i++) {
					_7a.children("div.datagrid-group[group-index=" + i + "]")
