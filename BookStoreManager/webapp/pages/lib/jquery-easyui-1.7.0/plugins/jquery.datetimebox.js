...
(function ($) {
    ...
    $.fn.datetimebox.defaults = $.extend({}, $.fn.datebox.defaults, {
        ...
        formatter: function (_2e) {
            ...
            return $.fn.datebox.defaults.formatter.call(this, _2e)
                + " "
                + $.fn.timespinner.defaults.formatter.call($(this)
                    .datetimebox("spinner")[0], _2e);
        },
        parser: function (s) {
            s = $.trim(s);
            if (!s) {
            ...
            var _30 = $.fn.timespinner.defaults.parser.call($(this)
                .datetimebox("spinner")[0], dt[1]
                + (dt[2] ? " " + dt[2] : ""));
            return new Date(_2f.getFullYear(), _2f.getMonth(), _2f
                .getDate(), _30.getHours(), _30
                .getMinutes(), _30.getSeconds());
        }
    });
})(jQuery);
