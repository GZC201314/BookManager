...
public class Book {
    ...
    public String toString() {
        return "Book [code=" + code + ", isbn=" + isbn + ", clc=" + clc + ", splitIsbn=" + splitIsbn + ", name=" + name
                + ", englishName=" + englishName + ", title=" + title + ", seriesName=" + seriesName + ", copiesCount="
                + copiesCount + ", cip=" + cip + ", author=" + author + ", introduction=" + introduction + ", content="
                + content + ", publisher=" + publisher + ", publishingTime=" + publishingTime + ", publishingAddress="
                + publishingAddress + ", edition=" + edition + ", print=" + print + ", score=" + score + ", translate="
                + translate + ", editor=" + editor + ", illustrator=" + illustrator + ", pageCount=" + pageCount
                + ", folio=" + folio + ", size=" + size + ", weight=" + weight + ", price=" + price + ", image=" + image
                + "]";
    }
