...
// Generated 2019-12-31 10:19:47 by Hibernate Tools 5.3.1.Final
 ...
 * @see org.gzc.echarts.model.Book
...
public class BookHome {
	...
	public Book findById(java.lang.String id) {
		...
		try {
			Book instance = (Book) sessionFactory.getCurrentSession().get("org.gzc.echarts.model.Book", id);
			if (instance == null) {
	...
	public List findByExample(Book instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("org.gzc.echarts.model.Book")
